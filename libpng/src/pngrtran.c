...
void png_set_background_fixed(png_struct * png_ptr,
...
void png_set_background(png_struct * png_ptr,
    png_const_color_16p background_color, int background_gamma_code,
    int need_expand, double background_gamma)
{
   png_set_background_fixed(png_ptr, background_color, background_gamma_code,
      need_expand, png_fixed_2(png_ptr, background_gamma, "png_set_background"));
}
...
void png_set_quantize(png_struct * png_ptr, png_colorp palette,
...
void png_set_gamma_fixed(png_struct * png_ptr, png_fixed_point scrn_gamma,
...
#  ifdef PNG_FLOATING_POINT_SUPPORTED
void png_set_gamma(png_struct * png_ptr, double scrn_gamma, double file_gamma)
{
   png_set_gamma_fixed(png_ptr,
      png_fixed_2(png_ptr, scrn_gamma, "png_set_gamma screen gamma"),
      png_fixed_2(png_ptr, file_gamma, "png_set_gamma file gamma"));
}
...
void png_set_rgb_to_gray_fixed(png_struct * png_ptr, int error_action,
...
void png_set_rgb_to_gray(png_struct * png_ptr, int error_action, double red,
   double green)
{
   if (png_ptr == NULL)
      return;
   ...
   png_set_rgb_to_gray_fixed(png_ptr, error_action,
      png_fixed_2(png_ptr, red, "rgb to gray red coefficient"),
      png_fixed_2(png_ptr, green, "rgb to gray green coefficient"));
}
...
void png_set_read_user_transform_fn(png_struct * png_ptr, png_user_transform_ptr
 ...
 */
void /* PRIVATE */
png_read_transform_info(png_struct * png_ptr, png_infop info_ptr)
{
 ...
 */
int /* PRIVATE */
png_do_rgb_to_gray(png_struct * png_ptr, png_row_infop row_info, png_bytep row)
