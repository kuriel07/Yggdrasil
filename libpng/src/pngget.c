    ...
    png_const_infop info_ptr)
{
       ...
       && info_ptr->y_pixels_per_unit <= PNG_UINT_31_MAX)
   {
       ...
       */
      if (png_muldiv_2(&res, (png_int_32)info_ptr->y_pixels_per_unit, PNG_FP_1,
...
ppi_from_ppm(png_uint_32 ppm)
{
   ...
   if (ppm <= PNG_UINT_31_MAX && png_muldiv_2(&result, (png_int_32)ppm, 127,
       5000))
      return result;
...
png_fixed_inches_from_microns(png_structp png_ptr, png_int_32 microns)
{
    ...
    * returned.
    */
   return png_muldiv_warn_2(png_ptr, microns, 500, 127);
}
...
png_uint_32 png_get_sRGB(png_const_structp png_ptr, png_const_infop info_ptr,
...
png_uint_32 png_get_sCAL_fixed(png_structp png_ptr, png_const_infop info_ptr,
    int *unit, png_fixed_point *width, png_fixed_point *height)
{
       ...
       (info_ptr->valid & PNG_INFO_sCAL))
   {
      ...
      *width = png_fixed_2(png_ptr, atof(info_ptr->scal_s_width), "sCAL width");
      *height = png_fixed_2(png_ptr, atof(info_ptr->scal_s_height),
         "sCAL height");
...
int png_get_unknown_chunks(png_const_structp png_ptr, png_const_infop info_ptr,
