 ...
 * functions instead.
 */
void png_write_chunk(png_struct * png_ptr, png_const_bytep chunk_name,
 ...
 */
void png_write_chunk_start(png_struct * png_ptr, png_const_bytep chunk_name,
    png_uint_32 length)
{
   png_byte buf[8];
   ...
   png_calculate_crc_2(png_ptr, chunk_name, 4);
 ...
 */
void png_write_chunk_data(png_struct * png_ptr, png_const_bytep data,
    png_size_t length)
{
   ...
   if (data != NULL && length > 0)
   {
       ...
       */
      png_calculate_crc_2(png_ptr, data, length);
   }
}
...
static int /* PRIVATE */
png_text_compress(png_struct * png_ptr,
 ...
 */
void /* PRIVATE */
png_write_PLTE(png_struct * png_ptr, png_const_colorp palette,
    png_uint_32 num_pal)
{
   PNG_PLTE;
   png_uint_32 i;
...
/* Write an IDAT chunk */
void /* PRIVATE */
png_write_IDAT(png_struct * png_ptr, png_bytep data, png_size_t length)
{
   PNG_IDAT;
...
/* Write an iCCP chunk */
void /* PRIVATE */
png_write_iCCP(png_struct * png_ptr, png_const_charp name, int compression_type,
...
/* Write a sPLT chunk */
void /* PRIVATE */
png_write_sPLT(png_struct * png_ptr, png_const_sPLT_tp spalette)
{
   PNG_sPLT;
   png_size_t name_len;
   png_charp new_name;
...
void /* PRIVATE */
png_write_sBIT(png_struct * png_ptr, png_const_color_8p sbit, int color_type)
{
   PNG_sBIT;
   png_byte buf[4];
   png_size_t size;
...
void /* PRIVATE */
png_write_cHRM_fixed(png_struct * png_ptr, png_fixed_point white_x,
    ...
    png_fixed_point blue_y)
{
   ...
   if (png_check_cHRM_fixed_2(png_ptr, white_x, white_y, red_x, red_y,
...
void /* PRIVATE */
png_write_tRNS(png_struct * png_ptr, png_const_bytep trans_alpha,
...
void /* PRIVATE */
png_write_bKGD(png_struct * png_ptr, png_const_color_16p back, int color_type)
{
   PNG_bKGD;
   png_byte buf[6];
...
/* Write the histogram */
void /* PRIVATE */
png_write_hIST(png_struct * png_ptr, png_const_uint_16p hist, int num_hist)
{
   PNG_hIST;
   int i;
   png_byte buf[3];
 ...
 */
png_size_t /* PRIVATE */
png_check_keyword(png_struct * png_ptr, png_const_charp key, png_charpp new_key)
{
   png_size_t key_len;
   png_const_charp ikp;
   png_charp kp, dp;
...
/* Write a tEXt chunk */
void /* PRIVATE */
png_write_tEXt(png_struct * png_ptr, png_const_charp key, png_const_charp text,
    png_size_t text_len)
{
   PNG_tEXt;
   png_size_t key_len;
...
void /* PRIVATE */
png_write_zTXt(png_struct * png_ptr, png_const_charp key, png_const_charp text,
...
/* Write an iTXt chunk */
void /* PRIVATE */
png_write_iTXt(png_struct * png_ptr, int compression, png_const_charp key,
...
void /* PRIVATE */
png_write_pCAL(png_struct * png_ptr, png_charp purpose, png_int_32 X0,
...
void /* PRIVATE */
png_write_sCAL_s(png_struct * png_ptr, int unit, png_const_charp width,
 ...
 */
void /* PRIVATE */
png_write_tIME(png_struct * png_ptr, png_const_timep mod_time)
{
   PNG_tIME;
   png_byte buf[7];
...
void /* PRIVATE */
png_write_find_filter(png_struct * png_ptr, png_row_infop row_info)
{
   png_bytep best_row;
#ifdef PNG_WRITE_FILTER_SUPPORTED
...
void /* PRIVATE */
png_write_filtered_row(png_struct * png_ptr, png_bytep filtered_row)
{
   png_size_t avail;
