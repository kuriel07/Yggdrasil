 ...
 */
void png_write_info_before_PLTE(png_struct * png_ptr, png_infop info_ptr)
{
   ...
   if (info_ptr->unknown_chunks_num)
   {
      ...
      for (up = info_ptr->unknown_chunks;
           ...
           up++)
      {
         int keep = png_handle_as_unknown_2(png_ptr, up->name);
...
void png_write_info(png_struct * png_ptr, png_infop info_ptr)
{
 ...
 */
void png_write_end(png_struct * png_ptr, png_infop info_ptr)
{
...
static void png_reset_filter_heuristics(png_struct * png_ptr); /* forward decl */

png_struct * png_create_write_struct_2(png_const_charp user_png_ver, png_voidp error_ptr,
 ...
 */
void png_write_rows(png_struct * png_ptr, png_bytepp row,
 ...
 */
void png_write_image(png_struct * png_ptr, png_bytepp image)
{
...
void png_write_row(png_struct * png_ptr, png_const_bytep row)
{
   if (png_ptr == NULL)
      return;
...
void png_destroy_write_struct(png_struct ** png_ptr_ptr, png_infopp info_ptr_ptr)
{
...
static void
png_reset_filter_heuristics(png_struct * png_ptr)
{
...
static int
png_init_filter_heuristics(png_struct * png_ptr, int heuristic_method,
   int num_weights)
{
   if (png_ptr == NULL)
      return 0;
...
void png_set_filter_heuristics(png_struct * png_ptr, int heuristic_method,
...
void png_set_filter_heuristics_fixed(png_struct * png_ptr, int heuristic_method,
...
void png_set_write_user_transform_fn(png_struct * png_ptr, png_user_transform_ptr
...
void png_write_png(png_struct * png_ptr, png_infop info_ptr,
