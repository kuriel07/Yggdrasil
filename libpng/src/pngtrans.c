...
void png_set_shift(png_struct * png_ptr, png_const_color_8p true_bits)
{
 ...
 */
void png_set_filler(png_struct * png_ptr, png_uint_32 filler, int filler_loc)
{
...
void png_set_add_alpha(png_struct * png_ptr, png_uint_32 filler, int filler_loc)
{
...
void png_set_user_transform_info(png_struct * png_ptr, png_voidp
