...
void png_set_gAMA_fixed(png_structp png_ptr, png_infop info_ptr, png_fixed_point
    file_gamma)
{
...
#  ifdef PNG_FLOATING_POINT_SUPPORTED
void png_set_sCAL(png_structp png_ptr, png_infop info_ptr, int unit, double width,
    double height)
{
   png_debug1(1, "in %s storage function", "sCAL");
...
void png_set_sRGB_gAMA_and_cHRM(png_structp png_ptr, png_infop info_ptr,
    int srgb_intent)
{
...
void png_set_text(png_structp png_ptr, png_infop info_ptr, png_const_textp text_ptr,
    int num_text)
{
   int ret;
...
png_uint_32 png_permit_mng_features (png_structp png_ptr, png_uint_32 mng_features)
{
...
void png_set_keep_unknown_chunks(png_structp png_ptr, int keep, png_const_bytep
...
void png_set_user_limits (png_structp png_ptr, png_uint_32 user_width_max,
