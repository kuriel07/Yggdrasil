...
typedef PNG_CONST png_color * png_const_colorp;
...
typedef PNG_CONST png_color_16 * png_const_color_16p;
...
typedef PNG_CONST png_color_8 * png_const_color_8p;
...
typedef PNG_CONST png_sPLT_entry * png_const_sPLT_entryp;
...
typedef PNG_CONST png_sPLT_t * png_const_sPLT_tp;
...
typedef PNG_CONST png_text * png_const_textp;
...
typedef PNG_CONST png_time * png_const_timep;
...
typedef PNG_CONST png_unknown_chunk * png_const_unknown_chunkp;
typedef png_unknown_chunk * * png_unknown_chunkpp;
#endif

typedef struct png_info_def png_info;
typedef png_info * png_infop;
typedef PNG_CONST png_info * png_const_infop;
...
typedef PNG_CONST png_struct * png_const_structp;
typedef png_struct (* png_structp);

typedef void (* png_error_ptr)(png_structp, png_const_charp);
typedef void (* png_rw_ptr)(png_structp, png_bytep, png_size_t);
typedef void (* png_flush_ptr)(png_structp);
typedef void (* png_read_status_ptr)(png_structp, png_uint_32, 
    int);
typedef void (* png_write_status_ptr)(png_structp, png_uint_32, 
    int);
...
typedef int (* png_user_chunk_ptr)(png_structp, 
    png_unknown_chunkp);
#endif
 ...
 * following.
 */
typedef png_voidp (* png_malloc_ptr)(png_structp, 
    png_alloc_size_t);
