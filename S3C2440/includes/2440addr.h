...
// USB Host
#define HcRevision 			(*(volatile unsigned *)0x49000000)
#define HcControl			(*(volatile unsigned *)0x49000004)
#define HcCommonStatus 		(*(volatile unsigned *)0x49000008)
#define HcInterruptStatus 	(*(volatile unsigned *)0x4900000c)
#define HcInterruptEnable 	(*(volatile unsigned *)0x49000010)
#define HcInterruptDisable 	(*(volatile unsigned *)0x49000014)
#define HcHCCA 				(*(volatile unsigned *)0x49000018)
#define HcPeriodCuttentED 	(*(volatile unsigned *)0x4900001c)
#define HcControlHeadED 	(*(volatile unsigned *)0x49000020)
#define HcControlCurrentED 	(*(volatile unsigned *)0x49000024)
#define HcBulkHeadED 		(*(volatile unsigned *)0x49000028)
#define HcBulkCurrentED 	(*(volatile unsigned *)0x4900002c)
#define HcDoneHead 			(*(volatile unsigned *)0x49000030)
#define HcRmInterval 		(*(volatile unsigned *)0x49000034)
#define HcFmRemaining 		(*(volatile unsigned *)0x49000038)
#define HcFmNumber 			(*(volatile unsigned *)0x4900003c)
#define HcPeriodicStart 	(*(volatile unsigned *)0x49000040)
#define HcLSThreshold 		(*(volatile unsigned *)0x49000044)
#define HcRhDescriptorA 	(*(volatile unsigned *)0x49000048)
#define HcRhDescriptorB 	(*(volatile unsigned *)0x4900004c)
#define HcRhStatus 			(*(volatile unsigned *)0x49000050)
#define HcRhPortStatus1 	(*(volatile unsigned *)0x49000054)
#define HcRhPortStatus2 	(*(volatile unsigned *)0x49000058)
...
#define BIT_CAM			(0x1U<<6)		// Added for 2440.
#define BIT_BAT_FLT		(0x1U<<7)
#define BIT_TICK		(0x1U<<8)
#define BIT_WDT_AC97	(0x1U<<9)	// Changed from BIT_WDT to BIT_WDT_AC97 for 2440A  
...
#define BIT_NFCON		(0x1U<<24)		// Added for 2440.
...
#define BIT_ALLMSK		(0xffffffffU)

#define BIT_SUB_ALLMSK	(0x7fffU)			//Changed from 0x7ff to 0x7fff for 2440A 
#define BIT_SUB_AC97	(0x1U<<14)		//Added for 2440A 
#define BIT_SUB_WDT	(0x1U<<13)		//Added for 2440A 
#define BIT_SUB_CAM_P	(0x1U<<12)		// edited for 2440A.
#define BIT_SUB_CAM_C   (0x1U<<11)       // edited for 2440A
